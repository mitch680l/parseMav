...
/*
This is the parser. It takes in a stream of words from the fifo and parses them into commands.
*It does not do all of the parsing*
It will seperate sentances into words, and remove special characters.
It will ignore anything untill a valid vehicle is selected.
It will then ignore until a valid action is selected.
However, noise can still be present in the arguments after valid action is selected.

Example: blah blah rover blah blah blah move forward blah 10 over
Will initialize the rover and input command <"move", ["forward", "blah", "10"]>
*/
